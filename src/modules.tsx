...
export const MODULES: ModuleDef[] = [
  ...
  { path: '/hse', name: 'HSE', icon: IconHSE, chunk: 3, built: false,
    blurb: 'Health & safety observations and incident recording.', integrates: [] },
  { path: '/risk', name: 'Risk Mgmt', icon: IconRisk, chunk: 3, built: false,
  ...
  { path: '/projects', name: 'Projects', icon: IconProject, chunk: 3, built: false,
