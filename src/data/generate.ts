...
export function integrations(): Integration[] {
  ...
  const defs: Omit<Integration, 'status' | 'lastSyncMin' | 'latencyMs' | 'eventsToday'>[] = [
    ...
    { id: 'int-pagerduty', name: 'PagerDuty', vendor: 'PagerDuty', category: 'ITSM', protocol: 'Webhook', scope: 'All sites', internal: false },
    { id: 'int-splunk', name: 'Splunk Observability', vendor: 'Splunk (Cisco)', category: 'Observability', protocol: 'REST API', scope: 'ASH1 · LON1 · FRA1 · SIN1', internal: false },
    { id: 'int-genetec', name: 'Genetec Security Center', vendor: 'Genetec', category: 'Security', protocol: 'REST API', scope: 'ASH1 · LON1 · FRA1 · SIN1 · SYD1', internal: false },
    { id: 'int-teams', name: 'Microsoft Teams', vendor: 'Microsoft', category: 'Collaboration', protocol: 'Webhook', scope: 'All sites', internal: false },
    { id: 'int-poweriq', name: 'Sunbird Power IQ', vendor: 'Sunbird', category: 'DCIM', protocol: 'REST API', scope: 'PHX1 · SAO1 · TOK1', internal: false },
