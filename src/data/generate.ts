...
export function integrations(): Integration[] {
  ...
  const defs: Omit<Integration, 'status' | 'lastSyncMin' | 'latencyMs' | 'eventsToday'>[] = [
    ...
    { id: 'int-si7', name: 'SI7 CMMS', vendor: 'CBRE', category: 'CMMS', protocol: 'REST API', scope: 'ASH1 · LON1 · SIN1', internal: true },
    { id: 'int-maximo', name: 'IBM Maximo', vendor: 'IBM', category: 'CMMS', protocol: 'REST API', scope: 'PHX1 · FRA1 · TOK1', internal: false },
    { id: 'int-servicenow', name: 'ServiceNow FSM', vendor: 'ServiceNow', category: 'ITSM', protocol: 'MCP', scope: 'SAO1 · DUB1', internal: false },
    { id: 'int-corrigo', name: 'Corrigo', vendor: 'JLL Technologies', category: 'CMMS', protocol: 'REST API', scope: 'TOR1 · SYD1', internal: false },
    { id: 'int-kahua', name: 'Kahua (Projects)', vendor: 'Kahua', category: 'Project Mgmt', protocol: 'REST API', scope: 'All sites', internal: true },
